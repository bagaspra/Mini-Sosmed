    ...
    <footer className="fixed bottom-0 left-0 z-20 p-4 w-full shadow items-center bg-gray-800 border-gray-600">
      <ul className="flex flex-wrap items-center mt-3 text-sm text-gray-400 sm:mt-0 justify-center">
        <li>
          <Link
            to="/"
            className="mr-6 hover:underline text-white flex items-center flex-col text-sm"
          >
        ...
        <li>
          <button
            className="navigation-button hover:underline text-white flex items-center flex-col text-sm"
            type="button"
            onClick={signOut}
          >
